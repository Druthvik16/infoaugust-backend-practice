...
db.updatePdfBotProcessLogStatus = (botName, botStatus, isBillNoExist, isSummaryFileExist, isPdfFileExist, isExecuteBot, lastActiveOn) =>
{
    return new Promise((resolve, reject) =>
    {
        try
        {
            let sql = `UPDATE pdf_bot_process_log SET bot_status = '${botStatus}', is_bill_number_exist = '${isBillNoExist}',
...
db.insertPdfBotProcessLogDetail = (botName, startedOn) =>
{
    return new Promise((resolve, reject) =>
    {
        try
        {
            let sql = `INSERT INTO pdf_bot_process_log_detail (bot_name, started_on) VALUES ('${botName}', ?); `
...
db.updatePdfBotProcessLogDetail = (detailId, completedOn) =>
{
    return new Promise((resolve, reject) =>
    {
        try
        {
            let sql = `UPDATE pdf_bot_process_log_detail SET completed_on = ? WHERE id = '${detailId}' `
