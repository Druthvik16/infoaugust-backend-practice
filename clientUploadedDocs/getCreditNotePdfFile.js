...
module.exports = require('express').Router().post('/',async(req,res) => 
{
    ...
    { 
        ...
        {
            await uniqueFunction.writeLogIntoFile("Provide all values : FilePath Missing", logFileName, "Get Credit Note Pdf File", getPath.getName('s3/creditNote/pdf'), 'red')
            res.status(400)
            return res.json({
                "status_code" : 400,
        ...
        //     if (err) 
        //     {
        //         await uniqueFunction.writeLogIntoFile(err?.stack, logFileName, "Get Credit Note Pdf File : " + filePath, getPath.getName('s3/creditNote/pdf'), 'red')
        ...
        //         {
        //             await uniqueFunction.writeLogIntoFile("Encription key not found for file", logFileName, "Get Credit Note Pdf File : " + fileName, getPath.getName('s3/creditNote/pdf'), 'red')
        //             res.status(500)
        //             return res.json({
        //                 "status_code" : 500,
        ...
        //                 await uniqueFunction.writeLogIntoFile("File Downloaded by Bot Process", logFileName, "Get Credit Note Pdf File : " + fileName, getPath.getName('s3/creditNote/pdf'), 'green')
        //                 res.sendFile(__dirname+"/"+fileName)
        //             }
        //             else
        //             {
        //                 await uniqueFunction.writeLogIntoFile("File Not Decrypted", logFileName, "Get Credit Note Pdf File : " + fileName, getPath.getName('s3/creditNote/pdf'), 'red')
        //                 res.status(500)
        //                 return res.json({
        //                     "status_code" : 500,
    ...
    {
        console.log("e************", e)
        await uniqueFunction.writeLogIntoFile(e?.stack, logFileName, "Get Credit Note Pdf File Catch", getPath.getName('s3/creditNote/pdf'), 'red')
        res.status(500)
        return res.json({
            "status_code" : 500,
            "message"     : "Error",
...
async function getFileFromS3bucket(filePath, res)
{
    ...
    {
        console.log("e************", e)
        await uniqueFunction.writeLogIntoFile(e?.stack, logFileName, "Get Credit Note Pdf File Catch (s3 bucket)", getPath.getName('s3/creditNote/pdf'), 'red')
        res.status(500)
        return res.json({
            "status_code" : 500,
            "message"     : "Error",
...
async function getFileFromLocal(filePath, res)
{
    ...
    {
        console.log("e************", e)
        await uniqueFunction.writeLogIntoFile(e?.stack, logFileName, "Get Credit Note Pdf File Catch (local)", getPath.getName('s3/creditNote/pdf'), 'red')
        res.status(500)
        return res.json({
            "status_code" : 500,
            "message"     : "Error",
