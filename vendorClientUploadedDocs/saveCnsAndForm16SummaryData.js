...
module.exports = require('express').Router().post('/',async(req,res) => 
{
    try
    {
        ...
        let saveClientUploadedDocMaster = await db.saveClientUploadedDocMaster(documentDate, invoiceNumber, documentCategoryId, documentId, vendorUuid, clientUuid, narration, monthPeriod, postingDate, debitAmount, creditAmount, billNoOrRefNo, createdOn, openingBalance, closingBalance, period, financialYear)
