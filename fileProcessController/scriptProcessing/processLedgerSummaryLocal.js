...
let apiName = '/api/fileProcessController/processLedgerSummaryLocal'
    ...
    return new Promise(async(resolve, reject) => 
    {
        try
        {
            ...
            else
            {
                ...
                return resolve(await readPythonScript(document, documentCategories, "clientUploadedDocs/partnerLocationLDGR.txt", documentAttachments, clientId, clientUuid, fileObject, '', "clientUploadedDocs/clientUploadedLedgerDocsPostingDate.txt", dailyActivityLogId, encriptionKey, encriptionIV, inputFolderPath))
            }
        } 
        catch(e)
        {
