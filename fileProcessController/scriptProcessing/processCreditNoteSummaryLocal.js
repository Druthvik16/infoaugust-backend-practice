...
let apiName = '/api/fileProcessController/processCreditNoteSummaryLocal'
    ...
    return new Promise(async(resolve, reject) => 
    {
        try
        {
            ...
            else
            {
                ...
                return resolve(await readPythonScript(document, documentCategories, "clientUploadedDocs/partnerLocationCNS.txt", documentAttachments, clientId, clientUuid, fileObject, '', "clientUploadedDocs/billNoCNS.txt", dailyActivityLogId, encriptionKey, encriptionIV, inputFolderPath))
            }  
        } 
        catch(e)
        {
