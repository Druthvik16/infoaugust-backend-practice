...
let apiName = '/api/fileProcessController/getInvoiceSummaryFileFromInputFolderLocal'

let processInvoiceSummaryLocal = require('../scriptProcessing/processInvoiceSummaryLocal')

let getInvoiceSummary = {}

getInvoiceSummary.getFileList = () => 
{
...
async function sendToISScript(file) 
{
    return new Promise(async(resolve, reject) => 
    {
        try
        {
            ...
            let processFile = await processInvoiceSummaryLocal.getFileList(params.uploadISFile, params.inputFolderPath, params.encriptionIV, params.encriptionKey, params.client)
