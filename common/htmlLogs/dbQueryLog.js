...
db.getLogProcesses = () => 
{
    return new Promise((resolve, reject) => 
    {
        try
        {
            let sql = `SELECT id, code, name FROM hmtl_log_process       
                        ORDER BY id`
...
db.getPdfBotLogDetails = (date, botName) => 
{
    return new Promise((resolve, reject) => 
    {
        try
        {
            ...
            FROM pdf_bot_process_log_detail 
...
db.getDailyActivityLogDetails = (date) => 
    {
        return new Promise((resolve, reject) => 
        {
            try
            {
                ...
                FROM daily_activity_detail dad 
                JOIN daily_activity_log dal ON dal.id = dad.daily_activity_detail_id AND DATE(dal.activity_date) =  '${date}'
