...
let userId;
let loggedUserUuid;
let s3Folder = 'Input_Monthly_Transactions_Raw_Sap_dump'
...
module.exports = require('express').Router().post('/',async(req,res) =>
{
    try
    {
        ...
        form.parse(req, async function (error, fields, files) 
        {
            ...
            fileObject.monthlyTransactionFile.forEach(file => {
            ...
            {
                uploadFileOnS3Bucket(fileObject.monthlyTransactionFile, 0, fileObject.monthlyTransactionFile?.length, clientUuid, 0, res, clientId, documentAttachmentId, status, documentCategoryId, [])
            }
            else
            {
                uploadFileOnLocal(fileObject.monthlyTransactionFile, 0, fileObject.monthlyTransactionFile?.length, clientUuid, 0, res, clientId, documentAttachmentId, status, documentCategoryId, [])
            }
        })  
    } 
    catch(e)
    {
        ...
        return res.json({
            "status_code" : 500,
            "message" : "Monthly Transaction Upload Failed",
