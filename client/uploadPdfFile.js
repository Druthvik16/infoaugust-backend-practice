...
module.exports = require('express').Router().post('/',async(req,res) =>
{
    try
    {
        ...
        form.parse(req, async function (error, fields, files) 
        {
            ...
            fileObject.pdfFile.forEach(file => {
            ...
            {
                uploadFileOnS3Bucket(fileObject.pdfFile, 0, fileObject.pdfFile?.length, clientUuid, 0, res, clientId, documentAttachmentId, status, documentCategoryId, [])
            }
            else
            {
                uploadFileOnLocal(fileObject.pdfFile, 0, fileObject.pdfFile?.length, clientUuid, 0, res, clientId, documentAttachmentId, status, documentCategoryId, [])
            }
        })  
    } 
    catch(e)
    {
        ...
        return res.json({
            "status_code" : 500,
            "message" : "Credit Note Pdf Upload Failed",
